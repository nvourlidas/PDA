...
<div class="topnav">
  ...
  <a class="active" href="modify-user.php" style="width:31%">Modify User</a>
  <a href="delete-user.php" style="width:30%">Delete User</a>
...
<?php
  ...
  while($row = $result->fetch_assoc()){
    echo"<tr><form action=modify.php method=post>";
